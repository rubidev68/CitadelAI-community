...
class SimpleMemoryVectorStore implements MemoryVectorStoreType {
  ...
  constructor(documents: Document[], embeddings: LocalEmbeddings) {
  ...
  static async fromDocuments(documents: Document[], embeddings: LocalEmbeddings): Promise<SimpleMemoryVectorStore> {
