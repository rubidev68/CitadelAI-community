      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid gap-4">
          {chatbots.map((chatbot, index) => (
            <Card 
              key={chatbot.id} 
              className="hover:shadow-lg transition-all duration-300 cursor-pointer hover-scale bg-card/50 backdrop-blur-sm border-l-4 border-l-transparent hover:border-l-primary animate-fade-in" 
