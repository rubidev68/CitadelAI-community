...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    className={cn(
      ...
      "hover:w-4 hover:bg-muted/20",
      className,
    )}
    {...props}
  >
    <ScrollAreaPrimitive.ScrollAreaThumb className="relative flex-1 rounded-full bg-muted/60 hover:bg-muted/80 transition-all duration-200 ease-out cursor-pointer" />
  </ScrollAreaPrimitive.ScrollAreaScrollbar>
));
