...
const apiAuthLogger = logger.child({ service: 'user-backend', component: 'apiAuth' });
...
export const checkRateLimit = async (
  ...
  if (tokenRateLimiter) {
    ...
    // Cast to avoid cross-package express type incompatibilities (local @shared packages)
