 ...
 * Includes connection pool configuration and middleware for cache invalidation
 */
...
export function getPrismaClient(): PrismaClient {
  if (!prisma) {
    ...
    // Note: Prisma $use middleware was removed in Prisma 5+
    // Cache invalidation is handled explicitly in route handlers for better control
  }
  return prisma;
}
